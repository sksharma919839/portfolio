      ...
      <div>
          ...
          <ul className="flex items-center justify-evenly">
            <li className="sm:mr-[15px] mr-[5px]">
              <button
                className={
                  activeTab === 0
                    ? "sm:text-[18px] text-[16px] text-[#31c92c] about-btn"
                    : "sm:text-[18px] text-[16px] text-[#ffffff]"
                }
                onClick={() => onClick(0)}
              >
                Skills
        ...
        <div>
          {activeTab === 0 && (
            <div>
              <div className="my-[20px]">
                <p className="text-[#31c92c] text-[14px]">Web Design</p>
                <h6 className="text-[16px] text-[#ffffff]">
                  Designing Web Interface
                </h6>
              </div>
              <div>
                <p className="text-[#31c92c] text-[14px]">Web Development</p>
                <h6 className="text-[16px] text-[#ffffff]">
                  Web App Devlopment
                </h6>
              </div>
          ...
          {activeTab === 1 && (
            <div>
              <div className="mt-[20px]">
                <p className="text-[#31c92c] text-[14px]">2024</p>
                <h6 className="text-[16px] text-[#ffffff]">
              ...
              <div className="my-[10px]">
                <p className="text-[#31c92c] text-[14px]">2022</p>
                <h6 className="text-[16px] text-[#ffffff]">
                  12th From RBSE Ajmer
                </h6>
              </div>
              <div className="my-[10px]">
                <p className="text-[#31c92c] text-[14px]">2020</p>
                <h6 className="text-[16px] text-[#ffffff]">
